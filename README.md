...
Leica Q3 Digital Zoom - This plugin reads the crop geometry directly from the DNG and applies a matching centred crop in Lightroom's Develop module — no external tools or manual measurements needed.
